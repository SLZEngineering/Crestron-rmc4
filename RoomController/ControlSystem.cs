...
namespace RoomController
{
    public class ControlSystem : CrestronControlSystem
    {
        ...
        // ------------------------------------------------------------
        // TOUCHPANEL JOIN MAP
        // Digital joins (press actions from TS-770):
        //   Join 1  -> Room On
        //   Join 2  -> Room Off
        //   Join 3  -> Volume Up
        //   Join 4  -> Volume Down
        ...
        //   Join 6  -> Teams Home
        //
        // Digital feedback joins (to TS-770):
        //   Join 101 -> Q-SYS online indicator
        //   Join 102 -> Yealink A20 online indicator
        //   Join 103 -> System ready (both devices online)
        //
        // Serial joins (to TS-770):
        //   Join 1  -> Status text
        // ------------------------------------------------------------
        ...
        {
            // Optional: cleanup on program stop
        }
